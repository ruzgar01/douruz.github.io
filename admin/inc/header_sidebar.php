        ...
        <ul class="list-unstyled accordion_menu overflow-auto element">
            ...
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                ...
                <ul>
                    ...
                    <li ><a style="color: #fff" <?php if ($page_title === "Mernis 2022") echo 'style="color: #fff !important;"' ?> href="/mernis2022"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">2022 Sorgu</a></li>
                    ...
                    <!--<li><a style="color: #fff" <?php if ($page_title === "Aile Sorgu V2") echo 'style="color: #83d8ae !important;"' ?> href="/v2aile"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">Aile Sorgu V2</a></li>-->
            ...
            <!--<li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid"  <?php
                ...
                <ul>
                    <li><a style="color: #fff !important;" <?php if ($page_title === "Vesikalık Sorgu") echo 'style="color: #fff !important;"' ?> href="/vesikalik"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">Vesikalık Sorgu</a></li>
                </ul>
            </li>-->
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                if (
            ...
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                ...
                <ul>
                    <li><a style="color:#fff;" <?php if ($page_title === "Mernis 2015") echo 'style="color: #83d8ae !important;"' ?> href="/mernis2015"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">2015 Sorgu</a></li>
                    <li><a style="color:#fff;" <?php if ($page_title === "Facebook") echo 'style="color: #83d8ae !important;"' ?> href="/facebook"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">Facebook Sorgu</a></li>
                    <li><a style="color:#fff;" <?php if ($page_title === "GSM TC") echo 'style="color: #83d8ae !important;"' ?> href="/gsmtc"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">GSM'den TC</a></li>
                </ul>
            </li>
            <?php if ($k_rol === "1") { ?>
                <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
